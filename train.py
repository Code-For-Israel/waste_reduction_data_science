...
#  5. grad clip
#  6. take the box with the max score during inference phase

# TODO YOTAM:
#  1. Train model with new clip
#  2. Prepare graphs - exp 2a 2b
#  3. Upload final checkpoint to google cloud
#  4. Arrange code repo
#  5. Calculate mean iou, accuracy based on .csv only
