...
TRAIN_DIRECTORY_PATH = os.path.join(SCRIPT_DIR, 'train_data_example')  # TODO DEL _example
TEST_DIRECTORY_PATH = os.path.join(SCRIPT_DIR, 'test_data_example')  # TODO DEL _example
