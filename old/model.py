...
class AuxiliaryConvolutions(nn.Module):
    ...
    def forward(self, conv7_feats):
        ...
        """
        out = F.relu(self.conv8_1(conv7_feats))  # (N, 256, 19, 19) # conv7_feast is given from VGGBase class
...
class SSD300(nn.Module):
    ...
    def detect_objects(self, predicted_locs, predicted_scores, min_score, max_overlap, top_k):
        ...
        :param top_k: if there are a lot of resulting detection across all classes, keep only the top 'k'  # TODO should keep?
        ...
        for i in range(batch_size):
            ...
            image_labels = image_labels[most_left_index]
